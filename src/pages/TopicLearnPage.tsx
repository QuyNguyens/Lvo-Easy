    ...
    <div className="w-full flex flex-col gap-5">
        ...
        <div className="flex justify-between">
          ...
          <div className="flex flex-col gap-6">
            ...
            <button onClick={() => dispatch(setCurrent(current+1))} className="min-w-64 py-2 flex items-center justify-center gap-1 font-medium rounded-md border bg-white border-gray-200 text-base18 hover:border-primary-1 hover:bg-blue-50">
